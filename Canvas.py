...
class canvas:
    ...
    def __init__(self,
        ...
        self.grid = [[[0, 0] for x in range(self.width)]
    ...
    def setcord(self,y,x,state: Literal[1,0]):
        y,x = round(x), round(y)
        self.grid[y][x][0] = state
        self.grid[y][x][1] = state
    ...
    def render(self):
        ...
        for y in self.grid:
            ...
            screen += '\033[0m\n'
        print(screen, end='\033[0{}'.format("\033[F" * (self.width * self.height)))
        time.sleep(0.1)